...
import { GiBattleGear, GiTwoCoins } from "react-icons/gi";
  ...
  async function handleGetAiQuiz(e) {
    ...
    try {
      ...
      if (resp?.data?.quiz) {
        ...
        toast.info('Next you click Send Challenge', {
          position: "top-right",
          autoClose: 5000,
          hideProgressBar: false,
          closeOnClick: false,
                  ...
                  <TabsContent value="ai-quiz" className="mt-4">
                    <div className="space-y-4 overflow-y-auto max-h-[44vh] pr-2">
                      <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
                        ...
                        <form className="space-y-5" onSubmit={handleGetAiQuiz}>
                          ...
                          >
                            {isLoadingAI ? (
                              ...
                              <span className={`flex items-center justify-center gap-2 ${isGetAiQuiz && 'cursor-not-allowed'}`}>
                        ...
                        <p className="w-full flex items-center justify-center gap-2 text-yellow-500 text-sm font-medium mt-1">
