  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900  font-sans px-2 md:px-4 py-6 flex items-center justify-center">
      ...
      <div className="w-full max-w-7xl bg-gray-50 rounded-2xl  p-4 md:p-6 grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8 text-gray-900">
        ...
        <div className="bg-gradient-to-br from-emerald-100 to-green-100 rounded-xl p-6 flex flex-col items-center text-center space-y-4 shadow-lg relative">
          <div className="">
            ...
            {streakDays > 0 && (
              <div className="absolute top-3 right-3">
                <div className="relative group">
                  ...
                  <div className="relative bg-gradient-to-br from-orange-400 to-red-500 text-white rounded-full py-1 px-2 flex  items-center justify-center shadow-lg ring-2 ring-white/80 dark:ring-gray-700 hover:scale-105 transition-transform duration-200 cursor-pointer">
                    {/* Animated flame icon */}
                    <div className="relative">
                      <Flame className="w-5 h-5 text-orange-200 drop-shadow-lg animate-pulse" />
                      <div className="absolute inset-0 bg-orange-400 rounded-full blur-[6px] opacity-70 -z-10" />
                    </div>

                    {/* Streak number with subtle animation */}
                    <span className="text-xs font-bold tracking-tighter mt-0.5 transform group-hover:scale-110 transition-transform">
                      {streakDays}
                    </span>
                  </div>

                  {/* Glow effect */}
                  <div className="absolute inset-0 rounded-full bg-orange-500/40 blur-[12px] opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10" />

                  {/* Optional tooltip */}
                  <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 bg-gray-800 text-white text-xs px-2 py-1 rounded whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none">
