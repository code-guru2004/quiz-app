...
export default function AIAttendPage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 text-gray-900 dark:text-gray-100 relative overflow-x-hidden">
            ...
            <div className='sticky top-6 right-6 lg:z-50 z-10'>
                <ThemeToggle />
            </div>
            ...
            <div className="max-w-7xl mx-auto px-0.5 lg:px-4 py-20 gap-8 z-30">
                {/* Quiz Container */}
                <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden border border-gray-200 dark:border-gray-700 transition-all duration-300">
                    ...
                    <div className="bg-gradient-to-r from-blue-600 to-indigo-600 p-6 text-white relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            <h1 className="text-2xl md:text-3xl font-bold">{aiQuiz.topic} Quiz</h1>
                    ...
                    <div className="flex flex-col lg:flex-row">
                        {/* Sidebar Navigation */}
                        {!showScore && (
                            <div className="lg:w-1/4 p-1.5 lg:p-6 border-r border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/30">
                        ...
                        <div className={`flex-1 p-1 lg:p-6 transition-opacity duration-300 ${isAnimating ? 'opacity-50' : 'opacity-100'}`}>
                            ...
                            {showScore ? (
                                            ...
                                            {questions.map((q, idx) => {
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        {/* Choices */}
                                                        <div className="space-y-3 ml-0 lg:ml-14">
                                ...
                                <>
                                    {/* Progress Bar */}
                                    <div className="mb-8 sm:p-2 lg:p-0.5">
                                    ...
                                    {/* Question Card */}
                                    <div className="bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 px-2 py-5 lg:p-8 rounded-2xl shadow-lg mb-8 transition-all duration-300 hover:shadow-xl">
                                        <div className=" items-start mb-6 hidden lg:flex">
                                            ...
                                            <div
                                                className="mb-3 text-gray-800 dark:text-gray-100 w-full"
                                                dangerouslySetInnerHTML={{ __html: currentQ.mainQuestion }}
                                            />
                                        </div>
                                        <div
                                            className="mb-3 text-gray-800 dark:text-gray-100 w-full block lg:hidden"
                                            dangerouslySetInnerHTML={{ __html: currentQ.mainQuestion }}
                                        />
                                        <div className="grid gap-3 ml-0 lg:ml-14">
